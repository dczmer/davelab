# Developer Productivity 04 - `tmux` Configuration
...
If you've ever [configured a prompt-string for your shell](../01_zsh-configuration/02_prompt/README.md), then you know how this works. Of course, `tmux` has it's own system and syntax, different from that of `zsh`. But, just like configuring your `zsh` prompt, you probably only need to do it one time, and it's not actually very hard.
