...
![image](./images/PS1-simple.png){:width="250" height="20"}

An example of a prompt generated by another program (`p10k`):

![image](./images/PS1-p10k.png){:width="442" height="34"}
...
![image](./images/PS1-default.png "Default prompt"){:width="96" height="20"}
...
![image](./images/rprompt.png){:width="937" height="29"}
